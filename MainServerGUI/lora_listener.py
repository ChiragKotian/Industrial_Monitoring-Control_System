...
AES_KEY = b"DEMO_16CHARACTER"
AES_IV  = bytes([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
                ...
                for rx in packet["rxpk"]:
                    ...
                    if raw_base64:
                        ...
                        if clean_csv:
                            ...
                            # Append the clean string directly into our live database
                            with open("live_database.csv", "a", encoding="utf-8") as f:
                                # Ensure it ends with a newline
                                f.write(clean_csv.strip() + "\n")
